...
В приложении можно получать данные из базы данных и сохранять их в свою таблицу, фильтровать фильмы по нескольким параметрам. Имеется вход через админку для управления записями, а также возможность предложить фильм к добавлению с гостевого аккаунта.
